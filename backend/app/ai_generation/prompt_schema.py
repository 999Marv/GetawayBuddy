def schema(prompt):
    ...
    return [
        ...
        {"role": "user", "content": f"To your best ability, generate a {prompt['days']} day itinerary, including Morning, Afternoon, and Nighttime {prompt['type_of_activity']} activities to do in {prompt['country']}. Keep activities to 2 sentences short and clear. Always respond strictly in JSON format with double-quoted keys and values, for example: {{\"day1\": \"morning: 'activity', afternoon: 'activity', nighttime: 'activity'\"}}. Do not include any extra text outside the JSON."}
    ]
